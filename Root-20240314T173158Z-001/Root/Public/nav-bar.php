    ...
    <div id="top-row">
        <ul class="nav-links">
            ...
            ?>
                ...
                <li><a href="logout.php"><span></span><i class="fa fa-sign-out" aria-hidden="true"></i>log out</a></li>
            ...
            <li><a href="/Root/index.php"><i class="fa fa-rebel" aria-hidden="true"></i> ASSASSIN</a></li>
                ...
                <li class="center"><a href="#">PRODUCT<span></span></a></li>
                <li class="upward"><a href="#">Services<span></span></a></li>
                <li><a href="signup.php"><span></span><i class="fa fa-user-plus" aria-hidden="true"></i> Sign Up</a></li>
                <li><a href="login.php"><span></span> <i class="fa fa-user-plus" aria-hidden="true"></i> Login</a></li>
            <?php
            }
            ?>
        </ul>
